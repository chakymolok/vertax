...
const COPY = {
  ...
  zh: {
    ...
    eco4Title: 'Not for the Dancefloor',
    eco4Text: '一个不追求 peak-time 的 mix 系列，更关注氛围、质感、flow 和细听。',
    eco5Title: 'Karacha',
    ...
    eco7Title: 'Onedam',
    eco7Text: '面向 Telegram / MAX mini-app、web app 和实用 digital service 的平台与方向。',
    eco8Title: 'Michael Proskurin',
  ...
  ja: {
    ...
    feat5Title: 'Vinyl-only Workflow',
    feat5Text:
      '手でプレイする感覚は残しつつ、盲目的に準備したくない vinyl-only セットに向いています。',
    feat6Title: 'Telegram Mini App',
