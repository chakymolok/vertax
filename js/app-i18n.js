...
(function () {
  ...
  var text = {
    en: {
      ...
      'Mini App стабильнее и быстрее. Хаптики, тёмная тема, оффлайн-режим.':
        'The Mini App is faster and more stable. Haptics, dark theme, offline mode.',
      'Открыть в Telegram →': 'Open in Telegram →',
      '♥ Поддержать VERTAX': '♥ Support VERTAX',
      'помочь развитию VERTAX': 'help VERTAX grow',
      'подобрать релизы под коллекцию': 'find releases that fit your collection',
    ...
    zh: {
      ...
      'Mini App стабильнее и быстрее. Хаптики, тёмная тема, оффлайн-режим.':
        'Mini App 更稳定更快。支持触觉反馈、深色模式和离线模式。',
      'Открыть в Telegram →': '在 Telegram 中打开 →',
      '♥ Поддержать VERTAX': '♥ 支持 VERTAX',
      'помочь развитию VERTAX': '帮助 VERTAX 发展',
      'подобрать релизы под коллекцию': '为收藏库匹配新版本',
      'Что докопать': '挖什么',
      '← Назад': '← 返回',
    ...
    ja: {
      ...
      'Mini App стабильнее и быстрее. Хаптики, тёмная тема, оффлайн-режим.':
        'Mini App はより安定して高速。触覚フィードバック、ダークテーマ、オフライン対応。',
      'Открыть в Telegram →': 'Telegram で開く →',
      '♥ Поддержать VERTAX': '♥ VERTAX を支援',
      'помочь развитию VERTAX': 'VERTAX の発展を支援',
      'подобрать релизы под коллекцию': 'コレクションに合う盤を探す',
      'Что докопать': '次に掘るもの',
      '← Назад': '← 戻る',
  ...
  var extraText = {
    en: {
      ...
      ИСТОЧНИК: 'Source',
      источник: 'source',
      'из пластинок': 'from records',
      'из треков': 'from tracks',
      'Выбрать релизы': 'Pick releases',
      'Выбрать треки': 'Pick tracks',
      'как сейчас: отметь пластинки, а Vertax соберёт сет из их треков':
        'as before: select records and Vertax will build a set from their tracks',
      'покажем все треки из пластинок в наличии, можно собрать точнее':
        'show all tracks from records you have, so the set can be more precise',
      'Выбери треки для сета': 'Pick tracks for the set',
      'Здесь все треки из пластинок в наличии. Можно собрать сет точечно, не выбирая релизы целиком.':
        'All tracks from records you have. Build a precise set without selecting whole releases.',
      'Поиск по трекам': 'Search tracks',
      Порядок: 'Order',
      'как выбрано': 'as picked',
      'по BPM': 'by BPM',
      'по Camelot': 'by Camelot',
      'Все треки': 'All tracks',
      'Очистить выбор': 'Clear selection',
      сторона: 'side',
      'Сторона обновлена': 'Side updated',
      'Нужно выбрать минимум 2 трека': 'Select at least 2 tracks',
      'Сет собран из треков': 'Set built from tracks',
      'Собрать сет из треков': 'Build set from tracks',
      'Выбери пластинки для сета': 'Pick records for the set',
    ...
    zh: {
      ...
      'Выбрать треки': '选择曲目',
      'как сейчас: отметь пластинки, а Vertax соберёт сет из их треков':
        '和之前一样：选择唱片，Vertax 会用其中的曲目生成 Set',
      'покажем все треки из пластинок в наличии, можно собрать точнее':
        '显示你已有唱片里的所有曲目，可以更精确地生成 Set',
      'Выбери треки для сета': '选择 Set 曲目',
      'Здесь все треки из пластинок в наличии. Можно собрать сет точечно, не выбирая релизы целиком.':
        '这里是你已有唱片里的全部曲目。无需选择整张发行，也可以精确生成 Set。',
      'Поиск по трекам': '搜索曲目',
      Порядок: '排序',
      'как выбрано': '按选择顺序',
      'по BPM': '按 BPM',
      'по Camelot': '按 Camelot',
      ...
      'Очистить выбор': '清空选择',
      сторона: '面',
      'Сторона обновлена': '唱片面已更新',
      'Нужно выбрать минимум 2 трека': '至少选择 2 首曲目',
      'Сет собран из треков': '已从曲目生成 Set',
      'Собрать сет из треков': '从曲目生成 Set',
      'Выбери пластинки для сета': '选择 Set 唱片',
      'Выделить все': '全选',
      'Снять всё': '全部取消',
      КОММЕНТАРИЙ: '备注',
      'Править трек': '编辑曲目',
    ...
    ja: {
      ...
      'из пластинок': 'レコードから',
      'из треков': '曲から',
      'Выбрать релизы': 'リリースを選択',
      'Выбрать треки': '曲を選択',
      'как сейчас: отметь пластинки, а Vertax соберёт сет из их треков':
        '従来どおり、レコードを選ぶと Vertax がその曲からセットを作ります',
      'покажем все треки из пластинок в наличии, можно собрать точнее':
        '持っているレコード内の全曲を表示し、より細かくセットを作れます',
      'Выбери треки для сета': 'セット用の曲を選択',
      'Здесь все треки из пластинок в наличии. Можно собрать сет точечно, не выбирая релизы целиком.':
        '持っているレコード内の全曲です。リリース全体を選ばず、曲単位でセットを作れます。',
      'Поиск по трекам': '曲を検索',
      Порядок: '順序',
      'как выбрано': '選択順',
      'по BPM': 'BPM順',
      'по Camelot': 'Camelot順',
      'Все треки': 'すべての曲',
      'Очистить выбор': '選択を解除',
      сторона: '面',
      'Сторона обновлена': '面を更新しました',
      'Нужно выбрать минимум 2 трека': '最低2曲を選択してください',
      'Сет собран из треков': '曲からセットを作成しました',
      'Собрать сет из треков': '曲からセットを作る',
      'Выбери пластинки для сета': 'セット用のレコードを選択',
      'Выделить все': 'すべて選択',
      'Снять всё': 'すべて解除',
      КОММЕНТАРИЙ: 'コメント',
